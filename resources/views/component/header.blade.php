...
<div class="w-full bg-white h-[96px] drop-shadow-lg flex flex-row items-center">
    <div class="w-1/3 pl-5 ">
      <a href="{{ route('home') }}" class="uppercase text-base mx-5 text-black hover:text-develobe-500 duration-200 font-inter">
        Filmes
      </a>
      <a href="{{ route('home') }}" class="uppercase text-base mx-5 text-black hover:text-develobe-500 duration-200 font-inter">
        tv-shows
    ...
    <div class="w-1/3 flex items-center justify-center">
      <a href="{{ route('home') }}" class="font-bold text-4xl font-quicksand text-black hover:text-develobe-500 duration-200">
        CINEMATION
      </a>
    </div>
    <div class="w-1/3 flex flex-row pr-10 justify-end">
